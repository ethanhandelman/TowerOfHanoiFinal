...
public class DragDropUtil {
    ...
    private static final SnapRange TOWER_1_BOTTOM = new SnapRange(TOWER_1_CENTER, TOWER_BOTTOM_Y, DEFAULT_RANGE, 1), TOWER_2_BOTTOM = new SnapRange(TOWER_2_CENTER, TOWER_BOTTOM_Y, DEFAULT_RANGE, 2), TOWER_3_BOTTOM = new SnapRange(TOWER_3_CENTER, TOWER_BOTTOM_Y, DEFAULT_RANGE, 3);
